module.exports = function(options) {
	...
	return function(req, dataStore, callback) {
		...
		//Get the groups the current user is in. Searches the request object for it, based on the option "requestGroups"
		var groups = req;
		var keys = options.requestGroups.split(".");
